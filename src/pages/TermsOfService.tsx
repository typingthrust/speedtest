      ...
      <div className="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="w-full bg-slate-800/50 rounded-lg p-6 sm:p-8 lg:p-10">
          ...
          <div className="space-y-8 text-slate-300 prose prose-invert max-w-none">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">3. User Accounts and Registration</h2>
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-4">3.1 Account Creation</h3>
              <p className="leading-relaxed text-base mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-4">3.2 Account Security</h3>
              <p className="leading-relaxed text-base">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">4. Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">5. Intellectual Property Rights</h2>
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-4">5.1 Our Intellectual Property</h3>
              <p className="leading-relaxed text-base mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-4">5.2 Your Content</h3>
              <p className="leading-relaxed text-base mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">6. Prohibited Activities</h2>
              <p className="leading-relaxed text-base mb-3">
                The following activities are strictly prohibited:
              </p>
              <ul className="list-disc list-outside space-y-2 text-base ml-6 text-slate-300 mb-4">
                <li><strong className="text-slate-100">Cheating:</strong> Using automated tools, scripts, or any method to artificially inflate typing speed, accuracy, or scores</li>
                <li><strong className="text-slate-100">Account Sharing:</strong> Sharing your account credentials with others or using someone else's account</li>
                <li><strong className="text-slate-100">Manipulation:</strong> Attempting to manipulate leaderboards, rankings, or statistics through any means</li>
                <li><strong className="text-slate-100">Spam:</strong> Sending unsolicited messages or communications to other users</li>
                <li><strong className="text-slate-100">Harassment:</strong> Engaging in any form of harassment, bullying, or abusive behavior</li>
                <li><strong className="text-slate-100">Reverse Engineering:</strong> Attempting to reverse engineer, decompile, or disassemble any part of the Service</li>
              </ul>
              <p className="leading-relaxed text-base">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">7. Service Availability and Modifications</h2>
              <p className="leading-relaxed text-base mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">8. Termination</h2>
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-4">8.1 Termination by You</h3>
              <p className="leading-relaxed text-base mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-4">8.2 Termination by Us</h3>
              <p className="leading-relaxed text-base mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">9. Disclaimers</h2>
              <p className="leading-relaxed text-base mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">11. Indemnification</h2>
              <p className="leading-relaxed text-base">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">12. Governing Law and Dispute Resolution</h2>
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-4">12.1 Governing Law</h3>
              <p className="leading-relaxed text-base mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-100 mb-3 mt-4">12.2 Dispute Resolution</h3>
              <p className="leading-relaxed text-base">
            ...
            <section>
              ...
              <ul className="list-disc list-outside space-y-2 text-base ml-6 text-slate-300">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">14. Severability</h2>
              <p className="leading-relaxed text-base">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">15. Entire Agreement</h2>
              <p className="leading-relaxed text-base">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-100 mb-4">16. Contact Information</h2>
              <p className="leading-relaxed text-base mb-4">
