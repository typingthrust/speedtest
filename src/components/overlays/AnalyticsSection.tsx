...
export function PerTestAnalyticsSection({ currentTestData, heading, subheading }: { currentTestData: any; heading: string; subheading: string }) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-card rounded-xl shadow border border-border p-6">
  ...
  return (
    <section className="w-full min-h-[40vh] bg-slate-900 flex flex-col items-center px-2 sm:px-8 py-8 gap-8">
      ...
      <div className="w-full grid grid-cols-2 md:grid-cols-3 gap-6 mb-4">
        <div className="bg-card/80 backdrop-blur-lg rounded-2xl p-6 flex flex-col items-center shadow-xl border border-border">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-card/80 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-border flex flex-col gap-2">
